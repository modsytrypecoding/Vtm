...
public class sendCorrect1 implements CommandExecutor{
	String Correct1 = Main.getconfig().getString("CorrectAwnser1");
	String False1 = Main.getconfig().getString("settings.Questions.Question1.settings.Questions.Question1.FalseAwnser1");
	String False2 = Main.getconfig().getString("settings.Questions.Question1.FalseAwnser2");
	...
	public boolean onCommand(CommandSender sender, Command command, String lable, String[] args) {
		if(sender instanceof Player) {
			...
			if(args.length == 0) {
				...
				p.sendMessage("                            ");
				p.sendMessage("§c[§6" + SecondNPCBuilder.NAMENPC2 + "§c]: §6" + Main.getconfig().getString("Question1"));
				tc1.setText("§c[§a" + Correct1 + "§c]" + " ");
				tc2.setText("§c[§a" + False1 + "§c]" + " ");
				tc3.setText("§c[§a" + False2 + "§c]" + " ");
				tc1.setClickEvent(new ClickEvent(Action.RUN_COMMAND, "/sendCorrect2"));
